...
o.f.BOB[0]['@isfat'] = True
print o.__repr__()

del o.f.BOB[0]['@isfat']
print o.__repr__()

o.f.BOB['The-Builder'].canfly = 'true'
print o.__repr__()

o.f.BOB['The-Builder'][1].canfly = 'FAAAAAAALSE'
print o.__repr__()

print 'btb value=%s' % o.f.BOB['The-Builder'].canfly
print 'btb value=%s' % o.f.BOB['The-Builder'][1].canfly
print 'btb value=%s' % o.f.BOB['The-Builder'][2].canfly

o.f.BOB['The-Builder'][2].canfly = 'true'
print o.__repr__()

del o.f.BOB['The-Builder'][1].canfly
print o.__repr__()

del o.f.BOB['The-Builder']
print o.__repr__()
